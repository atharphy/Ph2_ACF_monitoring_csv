#include "D19cBackendAlignmenntFWInterface.h"
...
namespace Ph2_HwInterface
{
    ...
    uint8_t D19cBackendAlignmenntFWInterface::ParseStatus()
    {
    ...
    void    D19cBackendAlignmenntFWInterface::SetAlignerObject(AlignerObject pAlignerObject)
    {
    ...
    void D19cBackendAlignmenntFWInterface::SetLineConfiguration(LineConfiguration pCnfg)
    {
    ...
    void    D19cBackendAlignmenntFWInterface::ConfigureInput()
    {
    ...
    void D19cBackendAlignmenntFWInterface::InitializeConfiguration()
    {
    ...
    void D19cBackendAlignmenntFWInterface::InitializeAlignerObject()
    {
    ...
    void D19cBackendAlignmenntFWInterface::ConfigureAligner(LineConfiguration pCnfg)
    {
        fLineConfiguration.fMode = pCnfg.fMode;
        fLineConfiguration.fDelay = pCnfg.fDelay;
        fLineConfiguration.fBitslip = pCnfg.fBitslip;
    ...
    void   D19cBackendAlignmenntFWInterface::ConfigureCommandType(uint8_t pType) 
    { 
        fAlignerObject.fType     = pType;
        ConfigureInput();
        fAlignerObject.fCommand += (fAlignerObject.fType & 0xF) << 16; 
    }
    void D19cBackendAlignmenntFWInterface::SendControl(std::string pCommand)
    {
    ...
    void   D19cBackendAlignmenntFWInterface::SetLineMode(AlignerObject pAlignerObject, LineConfiguration pLineConfiguration)
    {
        // select FE
    ...
    void   D19cBackendAlignmenntFWInterface::SetLinePattern(AlignerObject pAlignerObject, LineConfiguration pLineConfiguration)
    {
    ...
    uint8_t D19cBackendAlignmenntFWInterface::GetLineStatus(AlignerObject pAlignerObject)
    {
        // select FE
        SetAlignerObject(pAlignerObject);
        // print header
        LOG(DEBUG) << BOLDBLUE << "D19cBackendAlignmenntFWInterface \t Hybrid: " << RESET << +fAlignerObject.fHybrid << BOLDBLUE << ", Chip: " << RESET << +fAlignerObject.fChip << BOLDBLUE << ", Line: " << RESET << +fAlignerObject.fLine;
    ...
    void D19cBackendAlignmenntFWInterface::TunePhase(AlignerObject pAlignerObject, LineConfiguration pLineConfiguration )
    {
    ...
    bool D19cBackendAlignmenntFWInterface::IsLineWordAligned(AlignerObject pAlignerObject)
    {
        return (fStatus.fWordAlignmentFSMstate == 14 );
    }
    bool D19cBackendAlignmenntFWInterface::IsLinePhaseAligned(AlignerObject pAlignerObject)
    {
