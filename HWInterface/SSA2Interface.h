...
{ // begin class
  public:
    ...
    std::pair<std::pair<std::string, uint16_t>, std::vector<std::pair<std::string, uint16_t>>>  packLocalRegisters(Ph2_HwDescription::ReadoutChip* pSSA2, const std::string& dacName, const ChipContainer& localRegValues);
