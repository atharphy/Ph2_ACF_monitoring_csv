...
class RD53Interface : public ReadoutChipInterface
{
  public:
    ...
    int32_t ReadChipReg(Ph2_HwDescription::Chip* pChip, const std::string& regName, const bool updateReg = false) override;
    ...
    void ReadPixelMaskFromFW(Ph2_HwDescription::Chip* pChip, const int lastRow, const int lastCol, const size_t Ntimes);
    void CopyRegFromDefault(Ph2_HwDescription::Chip* pChip, const std::string& regName);
