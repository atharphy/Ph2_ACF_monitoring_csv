...
{
BeBoardFWInterface::BeBoardFWInterface(const std::string& puHalConfigFileName, uint32_t pBoardId, BeBoard* theBoard) : RegManager(puHalConfigFileName, pBoardId, theBoard), fSaveToFile(false), fFileHandler(nullptr) {}
