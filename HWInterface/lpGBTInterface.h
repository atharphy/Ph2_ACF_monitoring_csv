...
class lpGBTInterface : public ChipInterface
{
  public:
    ...
    float   GetLastNTCResistance(Ph2_HwDescription::lpGBT* pChip) {return pChip->getNTCResistance();};
    void   SetLastNTCResistance(Ph2_HwDescription::lpGBT* pChip, float res) {pChip->setNTCResistance(res);};
