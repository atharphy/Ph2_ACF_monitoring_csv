...
class lpGBTInterface : public ChipInterface
{
  public:
    ...
    void     ConfigureRxGroups2(Ph2_HwDescription::Chip* pChip, const std::vector<uint8_t>& pGroups, const std::vector<uint8_t>& pChannels, uint8_t pDataRate, uint8_t pTrackMode);
