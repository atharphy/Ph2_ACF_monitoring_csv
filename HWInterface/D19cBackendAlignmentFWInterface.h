...
class PhaseTuningControl
{
  ...
  public:
    ...
    enum class Command {ReturnConfig = 0, ReturnResult = 1, Configure = 2, SetPatternLength = 3, SetSyncPattern = 4, Align = 5, ReturnFSMstatus = 6};
    enum class Mode    {Auto = 0, Slave = 1, Manual = 2};
    // setter
...
{
  public:
    enum class WordFSMstate  {IdleWordOrWaitIserdese = 0, WaitFrame = 1, ApplyBitslip = 2, WaitBitslip = 3, PatternVerification = 4, NotDefined1 = 5, NotDefined2 = 6, NotDefined3 = 7, NotDefined4 = 8, NotDefined5 = 9, NotDefined6 = 10, NotDefined7 = 11, FailedFrame = 12, FailedVerification = 13, TunedWORD = 14, Unknown = 15};
    enum class PhaseFSMstate {IdlePHASE = 0, ResetIDELAYE = 1, WaitResetIDELAYE = 2, ApplyInitialDelay = 3, CheckInitialDelay = 4, InitialSampling = 5, ProcessInitialSampling = 6, ApplyDelay = 7, CheckDelay = 8, Sampling = 9, ProcessSampling = 10, WaitGoodDelay = 11, FailedInitial = 12, FailedToApplyDelay = 13, TunedPHASE = 14, Unknown = 15};
    // getter
