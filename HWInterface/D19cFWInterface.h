...
class D19cFWInterface : public BeBoardFWInterface
{
  ...
  public:
    ...
    //         if (fType == 0)
    //         {
    //             // fMode = (pReply & 0x00003000) >> 13;
    //             // fDelay = (pReply & 0x000000F8) >> 4;
    //             // fBitslip = (pReply & 0x00000007) >> 0;
    //             // after 640 mod
    //             fMode = (pReply & (0x3 << 13)) >> 13;
    //             fDelay = (pReply & (0x1F << 4)) >> 4;
    ...
    //                                                    {3, "ApplyBitslip"},
    //                                                    {4, "WaitBitslip"},
    //                                                    {5, "PatternVerification"},
    //                                                    {6, "ShiftFrame"},
    //                                                    {0xC, "FailedFrame"},
    //                                                    {0xD, "FailedVerification"},
    //                                                    {0xE, "TunedWord"},
    //                                                    {0xF, "Unknown"}};
    // };
    ...
    bool     WriteOptoLinkRegister(const uint32_t linkNumber, const uint32_t pAddress, const uint32_t pData, const bool pVerifLoop = true) override;
