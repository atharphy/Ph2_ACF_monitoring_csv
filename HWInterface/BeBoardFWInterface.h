...
class BeBoardFWInterface : public RegManager
{
  ...
  public:
    ...
    RunBERtest(bool given_time, double frames_or_time, const std::vector<std::pair<uint16_t, uint16_t>>& hybrid_id_chip_id, const std::vector<uint8_t>& chipLanes, uint8_t frontendSpeed) = 0;
