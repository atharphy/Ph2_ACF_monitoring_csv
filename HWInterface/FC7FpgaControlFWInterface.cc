...
{
    FC7FpgaControlFWInterface::FC7FpgaControlFWInterface(const char* puHalConfigFileName, uint32_t pBoardId, FileHandler* pFileHandler) : BeBoardFWInterface(puHalConfigFileName, pBoardId) {fFpgaConfig=nullptr;}
    FC7FpgaControlFWInterface::FC7FpgaControlFWInterface(const char* pId, const char* pUri, const char* pAddressTable, FileHandler* pFileHandler) : BeBoardFWInterface(pId, pUri, pAddressTable) {fFpgaConfig=nullptr;}
    ...
    const FpgaConfig* FC7FpgaControlFWInterface::GetConfiguringFpga(){ 
        return (const FpgaConfig*)fFpgaConfig; 
    }
