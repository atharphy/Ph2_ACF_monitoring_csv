...
void initializeFreeRegisters()
{
    listOfFreeRegistersMap[ChipType::LpGBT] = {
        std::make_pair(std::regex("^ConfigPins$"), RegisterType::ReadOnly),
    ...
    listOfFreeRegistersMap[ChipType::CIC] = {
        std::make_pair(std::regex("^EfuseValue[0-3]$"), RegisterType::ReadOnly),
    ...
    listOfFreeRegistersMap[ChipType::CBC] = {
        std::make_pair(std::regex("^ChipIDFuse[1-3]$"), RegisterType::ReadOnly),
        std::make_pair(std::regex("^BandgapFuse$"), RegisterType::ReadOnly)
    };
    ...
    listOfFreeRegistersMap[ChipType::SSA] = {
        std::make_pair(std::regex("^SEUcnt$"), RegisterType::ReadOnly),
