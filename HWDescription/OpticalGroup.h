    ...
    , public OpticalGroupContainer
{
  public:
    ...
    void addNTC(std::string cNTCType,std::string cNTCADC,std::string cNTCLookUpTable)
    {
      fNTCMap.insert( std::make_pair(cNTCType, std::make_pair(cNTCADC, cNTCLookUpTable)));
    }
