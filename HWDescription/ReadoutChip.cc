...
ReadoutChip::ReadoutChip(uint8_t pBeId, uint8_t pFMCId, uint8_t pFeId, uint8_t pChipId, uint16_t pMaxRegValue) : Chip(pBeId, pFMCId, pFeId, pChipId, pMaxRegValue), ChipContainer(pChipId) {}
