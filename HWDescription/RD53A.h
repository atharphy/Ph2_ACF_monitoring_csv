...
class RD53A : public RD53
{
  public:
    ...
    static constexpr FrontEnd SYNC = {"SYNC", "VTH_SYNC", "IBIAS_KRUM_SYNC", "LATENCY_CONFIG", 0, RD53Shared::setBits(RD53AEvtEncoder::NBIT_TOT) - 1, 0, 127};
    static constexpr FrontEnd LIN  = {"LIN", "Vthreshold_LIN", "KRUM_CURR_LIN", "LATENCY_CONFIG", 16, RD53Shared::setBits(RD53AEvtEncoder::NBIT_TOT) - 1, 128, 263};
    static constexpr FrontEnd DIFF = {"DIFF", "VTH1_DIFF", "VFF_DIFF", "LATENCY_CONFIG", 31, RD53Shared::setBits(RD53AEvtEncoder::NBIT_TOT) - 1, 264, 399};
