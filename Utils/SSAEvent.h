...
class SSAEvent : public Event
{
  public:
     ...
     */
    std::string DataHexString(uint8_t pHybridId, uint8_t pCbcId) const override { return ""; };
     ...
     * \return Error bit
     */
    bool Error(uint8_t pHybridId, uint8_t pCbcId, uint32_t i) const override { return false; };
    /*!
     ...
     * \return Error bit
     */
    uint32_t Error(uint8_t pHybridId, uint8_t pCbcId) const override { return 0; };
    /*!
     ...
     */
    uint32_t PipelineAddress(uint8_t pHybridId, uint8_t pCbcId) const override { return 0; };
    /*!
     ...
     * \return Data Bit
     */
    bool DataBit(uint8_t pHybridId, uint8_t pCbcId, uint32_t i) const override { return false; };
    /*!
     ...
     */
    std::string DataBitString(uint8_t pHybridId, uint8_t pCbcId) const override { return ""; };
    /*!
     ...
     */
    std::vector<bool> DataBitVector(uint8_t pHybridId, uint8_t pCbcId) const override { return std::vector<bool>(); };
    std::vector<bool> DataBitVector(uint8_t pHybridId, uint8_t pCbcId, const std::vector<uint8_t>& channelList) const override { return std::vector<bool>(); };
    /*!
     ...
     */
    std::string GlibFlagString(uint8_t pHybridId, uint8_t pCbcId) const override { return ""; };
    /*!
     ...
     * \return stub bit?
     */
    std::string StubBitString(uint8_t pHybridId, uint8_t pCbcId) const override { return ""; };
    /*!
     * \brief Function to get Stub bit
     * \param pHybridId : Hybrid Id
     * \param pCbcId : Cbc Id
     * \return stub bit?
     */
    bool StubBit(uint8_t pHybridId, uint8_t pCbcId) const override { return false; };
    /*!
     * \brief Get a vector of Stubs - will be empty for Cbc2
     * \param pHybridId : Hybrid Id
     * \param pCbcId : Cbc Id
     */
    std::vector<Stub> StubVector(uint8_t pHybridId, uint8_t pCbcId) const override { return std::vector<Stub>(); };
     ...
     */
    uint32_t GetNHits(uint8_t pHybridId, uint8_t pCbcId) const override { return false; };
    /*!
     ...
     */
    std::vector<uint32_t> GetHits(uint8_t pHybridId, uint8_t pCbcId) const override { return std::vector<uint32_t>(); };

    std::vector<Cluster> getClusters(uint8_t pHybridId, uint8_t pCbcId) const override { return std::vector<Cluster>(); };
