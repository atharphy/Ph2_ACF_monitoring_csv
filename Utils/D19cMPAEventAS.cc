...
void D19cMPAEventAS::fillChipDataContainer(ChipDataContainer* chipContainer, const std::shared_ptr<ChannelGroupBase> testChannelGroup, uint8_t hybridId)
{
    ...
    for(auto cHit: cHits)
    {
        if(testChannelGroup->isChannelEnabled(0, cChnl))
        {
