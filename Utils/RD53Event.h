...
class RD53Event : public Ph2_HwInterface::Event
{
  public:
    ...
    void fillRD53ChipDataContainer(ChipDataContainer* chipContainer, const std::shared_ptr<ChannelGroupBase> testChannelGroup, uint16_t hybridId, size_t chipIndx);
