...
void D19cMPAEvent::fillChipDataContainer(ChipDataContainer* chipContainer, const std::shared_ptr<ChannelGroupBase> testChannelGroup, uint8_t hybridId)
{
    unsigned int i = 0;
    ...
    {
        if(testChannelGroup->isChannelEnabled(0, i))
        {
            // TOFIX
