...
#ifndef __D19cSSA2EventAS_H__
#define __D19cSSA2EventAS_H__
...
class D19cSSA2EventAS : public Event
{
  public:
    D19cSSA2EventAS(const Ph2_HwDescription::BeBoard* pBoard, const std::vector<uint32_t>& list);
    D19cSSA2EventAS(const Ph2_HwDescription::BeBoard* pBoard, uint32_t pNSSA2, uint32_t pNFe, const std::vector<uint32_t>& list);
    ~D19cSSA2EventAS() {}
