...
class PSBiasCal : public Tool
{
  ...
  private:
    ...
    // const   std::map<hybrid_chip, float> MPA2_VBG_MEASURED_TABLE = { // in volts
    //   {std::make_pair(0, 0), 0.279109}, {std::make_pair(0, 1), 0.272822}, {std::make_pair(0, 2), 0.276339}, {std::make_pair(0, 3), 0.278336}, {std::make_pair(0, 4), 0.274634}, {std::make_pair(0, 5), 0.279094}, {std::make_pair(0, 6), 0.273236}, {std::make_pair(0, 7), 0.277316}, 
    //   {std::make_pair(1, 0), 0.276748}, {std::make_pair(1, 1), 0.276181}, {std::make_pair(1, 2), 0.273045}, {std::make_pair(1, 3), 0.273581}, {std::make_pair(1, 4), 0.280612}, {std::make_pair(1, 5), 0.275987}, {std::make_pair(1, 6), 0.280122}, {std::make_pair(1, 7), 0.270935}};
