...
void OTCMNoise::TakeData()
{
...
#else
    auto theHitStream = prepareOpticalGroupContainerStream<EmptyContainer,
                                                           GenericDataArray<NCHANNELS + 1, uint32_t>,
                                                           GenericDataArray<HYBRID_CHANNELS_OT + 1, uint32_t>,
    ...
    {
        auto the2DHitStream =
            prepareOpticalGroupContainerStream<EmptyContainer, EmptyContainer, EmptyContainer, GenericDataArray_2D<TOTAL_CHANNELS_OT, TOTAL_CHANNELS_OT, uint32_t>>("CMNoise_2DHitStream");
