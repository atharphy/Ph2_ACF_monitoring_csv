...
class WorkerTester : public Tool {
	...
	void ResetCPB();
        ...
        bool WriteFERegister(Chip* pChip, uint16_t pRegisterAddress, uint8_t pRegisterValue, bool pRetry = false, bool pVerbose=true);
        uint8_t ReadFERegister(Chip* pChip, uint16_t pRegisterAddress, bool pVerbose=true);
