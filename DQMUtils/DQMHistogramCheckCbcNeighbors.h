/*!
        \file                DQMHistogramCheckCbcNeighbors.h
        \brief               DQM class for CheckCbcNeighbors
        \author              Lesya Horyn
        \date                11/07/22
*/

#ifndef DQMHistogramCheckCbcNeighbors_h_
#define DQMHistogramCheckCbcNeighbors_h_
...
/*!
 * \class DQMHistogramCheckCbcNeighbors
 * \brief Class for CheckCbcNeighbors monitoring histograms
 */
class DQMHistogramCheckCbcNeighbors : public DQMHistogramBase
{
  public:
    /*!
     * constructor
     */
    DQMHistogramCheckCbcNeighbors();
