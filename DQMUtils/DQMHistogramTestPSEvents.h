/*!
        \file                DQMHistogramTestPSEvents.h
        \brief               DQM class for TestPSEvents
        \author              Fabio Ravera
        \date                25/11/24
*/

#ifndef DQMHistogramTestPSEvents_h_
#define DQMHistogramTestPSEvents_h_
...
/*!
 * \class DQMHistogramTestPSEvents
 * \brief Class for TestPSEvents monitoring histograms
 */
class DQMHistogramTestPSEvents : public DQMHistogramBase
{
  public:
    /*!
     * constructor
     */
    DQMHistogramTestPSEvents();
