/*!
        \file                DQMHistogramOTcountSSASpuriousClusters.h
        \brief               DQM class for OTverifyMPASSAdataWord
        \author              Fabio Ravera
        \date                07/03/24
*/

#ifndef DQMHistogramOTcountSSASpuriousClusters_h_
#define DQMHistogramOTcountSSASpuriousClusters_h_
...
/*!
 * \class DQMHistogramOTcountSSASpuriousClusters
 * \brief Class for OTverifyMPASSAdataWord monitoring histograms
 */
class DQMHistogramOTcountSSASpuriousClusters : public DQMHistogramBase
{
  public:
    /*!
     * constructor
     */
    DQMHistogramOTcountSSASpuriousClusters();
    ...
    void fillStubMissingCountContainer(DetectorDataContainer& theStubMissingCountContainer);
