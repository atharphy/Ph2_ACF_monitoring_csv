...
bool DQMHistogramOTverifyBoardDataWord::fill(std::string& inputStream)
{
    ...
    // As example, I'm expecting to receive a data stream from an uint32_t contained from calibration "OTverifyBoardDataWord"
    // ContainerSerialization myStreamer("OTverifyBoardDataWord");

    // if(myStreamer.attachDeserializer(inputStream))
    // {
    //     // It matched! Decoding data
    //     std::cout << "Matched OTverifyBoardDataWord!!!!!\n";
