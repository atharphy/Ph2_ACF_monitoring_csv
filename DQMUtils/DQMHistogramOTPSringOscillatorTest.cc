...
bool DQMHistogramOTPSringOscillatorTest::fill(std::string& inputStream)
{
    ...
    // As example, I'm expecting to receive a data stream from an uint32_t contained from calibration "OTPSringOscillatorTest"
    // ContainerSerialization myStreamer("OTPSringOscillatorTest");
    
    // if(myStreamer.attachDeserializer(inputStream))
    // {
    //     // It matched! Decoding data
    //     std::cout << "Matched OTPSringOscillatorTest!!!!!\n";
