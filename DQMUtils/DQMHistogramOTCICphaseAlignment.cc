...
bool DQMHistogramOTCICphaseAlignment::fill(std::string& inputStream)
{
    ...
    // As example, I'm expecting to receive a data stream from an uint32_t contained from calibration "OTCICphaseAlignment"
    // ContainerSerialization myStreamer("OTCICphaseAlignment");
    
    // if(myStreamer.attachDeserializer(inputStream))
    // {
    //     // It matched! Decoding data
    //     std::cout << "Matched OTCICphaseAlignment!!!!!\n";
