...
void DQMHistogramPedeNoise::book(TFile* theOutputFile, DetectorContainer& theDetectorStructure, const Ph2_Parser::SettingsMap& pSettingsMap)
{
    ...
    if(fWithMPA)
    {
        ...
        // Noise
        HistContainer<TH1F> theTH1FHybridPixelNoiseContainer("ChannelPixelNoise", "Channel pixel noise", fNPixelChannels * 8, -0.5, float(fNPixelChannels) * 8 - 0.5);
        ...
        // 2D Pixel Noise
        HistContainer<TH2F> theTH2FChannel2DPixelNoiseContainer("2DPixelNoise", "2D pixel noise", 120, -0.5, float(120) - 0.5, fNPixelChannels / 120, -0.5, float(fNPixelChannels / 120) - 0.5);
