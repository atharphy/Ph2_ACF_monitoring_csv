...
//========================================================================================================================
bool DQMHistogramRegisterTest::fill(std::vector<char>& dataBuffer)
{
                ...
                for(auto chip: *hybrid)
                {
                    ...
                    for( auto cItem : cComparisons)
                    {
                        ...
                        if( cPageTogglesChip.find( cItem.first ) != cPageTogglesChip.end() )
                        {
                            ...
                            LOG (DEBUG) << BOLDYELLOW << "Register " << +cRegisterAddress << " on page " << +cRegisterPage 
                                << " first mis-match after " << +cNtoggles
                                << " page toggles. Bin number is " << cBin
                                << RESET;
