...
int main(int argc, char** argv)
{
    ...
    if((reset == true) || (dumpRegs == true) || (binaryFile != ""))
    {
        ...
        if(reset == true)
        {
            if(mySysCntr.fDetectorContainer->topoGigio(0)->topoGigio(0)->flpGBT == nullptr)
                static_cast<RD53FWInterface*>(mySysCntr.fBeBoardFWMap[mySysCntr.fDetectorContainer->topoGigio(0)->getId()])->ResetSequence("160");
            else
                static_cast<RD53FWInterface*>(mySysCntr.fBeBoardFWMap[mySysCntr.fDetectorContainer->topoGigio(0)->getId()])->ResetSequence("320");
            exit(EXIT_SUCCESS);
        }
    ...
    else if(whichCalib == "pixelalive")
    {
        ...
        do
        {
            if(TESTSUBDETECTOR == true)
            {
                ...
                else if(pa.fDetectorContainer->topoGigio(0)->size() != 1)
                {
                ...
                else if(pa.fDetectorContainer->topoGigio(0)->topoGigio(0)->size() != 1)
                {
                ...
                else if(pa.fDetectorContainer->topoGigio(0)->topoGigio(0)->topoGigio(0)->size() != 1)
                {
