...
![VREF_DACtoV_Chip](/outerTracker/OTtesting/PS/VREF_DACtoV_Chip.png)

The second one is the ADC calibration curve obtained during the procedure.

![ADC_Slope_MPA](/outerTracker/OTtesting/PS/ADC_Slope_MPA.png)
...
![VTRx_LightYieldScan](/outerTracker/OTtesting/common/VTRx_LightYieldScan.png)
...
![VTRx_LightYieldScan_buggy](/outerTracker/OTtesting/common/VTRx_LightYieldScan_buggy.png)
</details>
...
![LpGBT_EyeOpeningScan](/outerTracker/OTtesting/common/LpGBT_EyeOpeningScan.png)
...
![CICtoLpGBT_PhaseAlignmentEfficiency](/outerTracker/OTtesting/PS/CICtoLpGBT_PhaseAlignmentEfficiency.png)
...
![CICtoLpGBT_FoundPhaseDistribution](/outerTracker/OTtesting/PS/CICtoLpGBT_FoundPhaseDistribution.png)
...
![CICtoLpGBT_BestPhase](/outerTracker/OTtesting/PS/CICtoLpGBT_BestPhase.png)
...
![Board_WordAlignmentBitSlipValues_Hybrid](/outerTracker/OTtesting/PS/Board_WordAlignmentBitSlipValues_Hybrid.png)
...
![Board_WordAlignmentRetryNumbers_Hybrid](/outerTracker/OTtesting/PS/Board_WordAlignmentRetryNumbers_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingTestedBits_Hybrid](/outerTracker/OTtesting/PS/CICtoLpGBT_PatternMatchingTestedBits_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingErrorRate_Hybrid](/outerTracker/OTtesting/PS/CICtoLpGBT_PatternMatchingErrorRate_Hybrid.png)
...
![MPAtoCIC_LockingEfficiency_Hybrid](/outerTracker/OTtesting/PS/MPAtoCIC_LockingEfficiency_Hybrid.png)
...
![MPAtoCIC_InputPhaseDistribution_Hybrid](/outerTracker/OTtesting/PS/MPAtoCIC_InputPhaseDistribution_Hybrid.png)
...
![MPAtoCIC_BestInputPhases_Hybrid](/outerTracker/OTtesting/PS/MPAtoCIC_BestInputPhases_Hybrid.png)
...
![MPAtoCIC_WordAlignmentDelay_Hybrid](/outerTracker/OTtesting/PS/MPAtoCIC_WordAlignmentDelay_Hybrid.png)
...
![CICBX0AlignmentDelay_Hybrid](/outerTracker/OTtesting/PS/CICBX0AlignmentDelay_Hybrid.png)
...
![Board_BestStubPackageDelay_OpticalGroup](/outerTracker/OTtesting/common/Board_BestStubPackageDelay_OpticalGroup.png)
...
![MPAtoCIC_PatternMatchingTestedBits_Hybrid](/outerTracker/OTtesting/PS/MPAtoCIC_PatternMatchingTestedBits_Hybrid.png)

Small error rates (around 0.01–0.1%) are normal and not a concern. Large errors, e.g., 20%, would indicate a real problem.


![MPAtoCIC_PatternMatchingErrorRate_Hybrid](/outerTracker/OTtesting/PS/MPAtoCIC_PatternMatchingErrorRate_Hybrid.png)
...
![SSAtoMPA_PatternMatchingTestedBits_Hybrid](/outerTracker/OTtesting/PS/SSAtoMPA_PatternMatchingTestedBits_Hybrid.png)
...
![SSAtoMPA_PatternMatchingErrorRate_Hybrid](/outerTracker/OTtesting/PS/SSAtoMPA_PatternMatchingErrorRate_Hybrid.png)
...
![SSAtoMPA_PatternMatchingErrorRate_Hybrid_missingWirebond](/outerTracker/OTtesting/PS/SSAtoMPA_PatternMatchingErrorRate_missingWirebond.png)

The one below is a known issue not yet understood. Please report if you observe it!

![SSAtoMPA_PatternMatchingErrorRate_Hybrid_clusterProblem](/outerTracker/OTtesting/PS/SSAtoMPA_PatternMatchingErrorRate_Hybrid_clusterProblem.png)
...
![MPA_RingOscillatorDelayCounts_Hybrid](/outerTracker/OTtesting/PS/MPA_RingOscillatorDelayCounts_Hybrid.png)

![MPA_RingOscillatorInverterCounts_Hybrid](/outerTracker/OTtesting/PS/MPA_RingOscillatorInverterCounts_Hybrid.png)

And here for SSA

![SSA_RingOscillatorDelayCounts_Hybrid](/outerTracker/OTtesting/PS/SSA_RingOscillatorDelayCounts_Hybrid.png)

![SSA_RingOscillatorInverterCounts_Hybrid](/outerTracker/OTtesting/PS/SSA_RingOscillatorInverterCounts_Hybrid.png)
...
![ChannelOffsetValues_SSA_quick](/outerTracker/OTtesting/PS/ChannelOffsetValues_SSA_quick.png)

![2DChannelOffsetValues_MPA_quick](/outerTracker/OTtesting/PS/2DChannelOffsetValues_MPA_quick.png)
...
![ChannelOccupancyAfterOffsetEqualization_SSA_quick](/outerTracker/OTtesting/PS/ChannelOccupancyAfterOffsetEqualization_SSA_quick.png)

![2DChannelOccupancyAfterOffsetEqualization_MPA_quick](/outerTracker/OTtesting/PS/2DChannelOccupancyAfterOffsetEqualization_MPA_quick.png)
...
![ChannelPedestal_SSA_full](/outerTracker/OTtesting/PS/ChannelPedestal_SSA_full.png)

![PedestalDistribution_SSA_full](/outerTracker/OTtesting/PS/PedestalDistribution_SSA_full.png)



MPA plots:

![ChannelPedestal_MPA_full](/outerTracker/OTtesting/PS/ChannelPedestal_MPA_full.png)

![PedestalDistribution_MPA_full](/outerTracker/OTtesting/PS/PedestalDistribution_MPA_full.png)

Offset (local threshold) that equalizes the channel to the target. Valid offset values range from 0 to 31. Channels stuck at 0 or 31 indicate the allowed range was not sufficient to correct the channel.

SSA: 

![ChannelTrimBit_SSA_full](/outerTracker/OTtesting/PS/ChannelTrimBit_SSA_full.png)

MPA:

![ChannelTrimBit_MPA_full](/outerTracker/OTtesting/PS/ChannelTrimBit_MPA_full.png)
...
![SCurve_1channel_SSA](/outerTracker/OTtesting/PS/SCurve_1channel_SSA.png)

MPA:

![SCurve_1channel_MPA](/outerTracker/OTtesting/PS/SCurve_1channel_MPA.png)
...
![SCurve_SSA](/outerTracker/OTtesting/PS/Scurve_SSA.png)
...
![SCurve_MPA](/outerTracker/OTtesting/PS/Scurve_MPA.png)
...
![SCurve_Chip_buggy](/outerTracker/OTtesting/2S/SCurve_Chip_buggy.png)
...
![PulseHeightDistribution_SSA](/outerTracker/OTtesting/PS/PulseHeightDistribution_SSA.png)

MPA:

![PulseHeightDistribution_MPA](/outerTracker/OTtesting/PS/PulseHeightDistribution_MPA.png)
...
![ChannelPulseHeight_SSA](/outerTracker/OTtesting/PS/ChannelPulseHeight_SSA.png)

MPA:

![ChannelPulseHeight_MPA](/outerTracker/OTtesting/PS/ChannelPulseHeight_MPA.png)
...
![NoiseDistribution_SSA](/outerTracker/OTtesting/PS/NoiseDistribution_SSA.png)

![ChannelNoise_SSA](/outerTracker/OTtesting/PS/ChannelNoise_SSA.png)

MPA:
![NoiseDistribution_MPA](/outerTracker/OTtesting/PS/NoiseDistribution_MPA.png)

![ChannelNoise_MPA](/outerTracker/OTtesting/PS/ChannelNoise_MPA.png)
...
![2DChannelNoise_MPA](/outerTracker/OTtesting/PS/2DChannelNoise_MPA.png)

There are there very similar distributions summarizing the performance at the hybrid level.

Strips:

![StripNoiseDistribution_Hybrid](/outerTracker/OTtesting/PS/StripNoiseDistribution_Hybrid.png)

Higher noise toward the POH (SSA0 on right hybrid and SSA7 on left hybrid) is expected.

![StripChannelNoise_Hybrid](/outerTracker/OTtesting/PS/StripChannelNoise_Hybrid.png)



Pixels:

![PixelNoiseDistribution_Hybrid](/outerTracker/OTtesting/PS/PixelNoiseDistribution_Hybrid.png)

![PIxelChannelNoise_Hybrid](/outerTracker/OTtesting/PS/PixelChannelNoise_Hybrid.png)
...
![StripChannelNoise_Scratch](/outerTracker/OTtesting/2S/StripChannelNoise_Scratch.png)

A channel with low noise could indicate a broken wirebond. Below 2 a broken bumpbond.

![StripChannelNoise_brokenBonds](/outerTracker/OTtesting/2S/StripChannelNoise_brokenBonds.png)

Groups of broken channels in the center of CBC can indicate that sparking occurred.

![StripChannelNoise_Sparking](/outerTracker/OTtesting/2S/StripChannelNoise_Sparking.png)
...
![ThresholdVsDelayScan_SSA](/outerTracker/OTtesting/PS/ThresholdVsDelayScan_SSA.png)

MPA:

![ThresholdVsDelayScan_MPA](/outerTracker/OTtesting/PS/ThresholdVsDelayScan_MPA.png)
...
![BestThresholdAndDelay_SSA](/outerTracker/OTtesting/PS/BestThresholdAndDelay_SSA.png)

![BestThresholdAndDelay_MPA](/outerTracker/OTtesting/PS/BestThresholdAndDelay_MPA.png)
...
![ChannelOccupancy_Injection_0.000_MIP_SSA](/outerTracker/OTtesting/PS/ChannelOccupancy_Injection_0.000_MIP_SSA.png)

MPA:

![ChannelOccupancy_Injection_0.000_MIP_MPA](/outerTracker/OTtesting/PS/ChannelOccupancy_Injection_0.000_MIP_MPA.png)
...
![ChannelOccupancy_Injection_0.250_MIP_SSA](/outerTracker/OTtesting/PS/ChannelOccupancy_Injection_0.250_MIP_SSA.png)

![ChannelOccupancy_Injection_1.000_MIP_SSA](/outerTracker/OTtesting/PS/ChannelOccupancy_Injection_1.000_MIP_SSA.png)

MPA:

The inefficiency in the edge pixels are not real. They are a result of the large double pixels.

![ChannelOccupancy_Injection_0.250_MIP_MPA](/outerTracker/OTtesting/PS/ChannelOccupancy_Injection_0.250_MIP_MPA.png)

![ChannelOccupancy_Injection_1.000_MIP_SSA](/outerTracker/OTtesting/PS/ChannelOccupancy_Injection_1.000_MIP_MPA.png)
...
![CommonNoiseHits_OccupancyDriven_SSA](/outerTracker/OTtesting/PS/CommonNoiseHits_OccupancyDriven_Chip_SSA.png)

MPA:

![CommonNoiseHits_OccupancyDriven_MPA](/outerTracker/OTtesting/PS/CommonNoiseHits_OccupancyDriven_Chip_MPA.png)
...
![CommonNoiseHitsStrip_OccupancyDriven_Hybrid](/outerTracker/OTtesting/PS/CommonNoiseHitsStrip_OccupancyDriven_Hybrid.png)

![CommonNoiseHitsPixel_OccupancyDriven_Hybrid](/outerTracker/OTtesting/PS/CommonNoiseHitsPixel_OccupancyDriven_Hybrid.png)
...
![SSAtoMPA_CommonNoiseCorrelation_OccupancyDriven_Hybrid](/outerTracker/OTtesting/PS/SSAtoMPA_CommonNoiseCorrelation_OccupancyDriven_Hybrid.png)
...
![CommonNoiseStripPixelCorrelation_OccupancyDriven_Hybrid](/outerTracker/OTtesting/PS/CommonNoiseStripPixelCorrelation_OccupancyDriven_Hybrid.png)


- OpticalGroup/Module level distributions

![CommonNoiseHitsStrip_OccupancyDriven_OG](/outerTracker/OTtesting/PS/CommonNoiseHitsStrip_OccupancyDriven_OG.png)

![CommonNoiseHitsPixel_OccupancyDriven_OG](/outerTracker/OTtesting/PS/CommonNoiseHitsPixel_OccupancyDriven_OG.png)


And the correlation at the hybrid level:

![CommonNoiseStripPixelCorrelation_OccupancyDriven_OG](/outerTracker/OTtesting/PS/CommonNoiseStripPixelCorrelation_OccupancyDriven_OG.png)
...
![SSAtoMPA_SamplingEdgeTestedBits_SSA_SLVScurrent_4_Hybrid](/outerTracker/OTtesting/PS/SSAtoMPA_SamplingEdgeTestedBits_SSA_SLVScurrent_4_Hybrid.png)
...
![SSAtoMPA_SamplingEdgeErrorRate_SSA_SLVScurrent_4_Hybrid](/outerTracker/OTtesting/PS/SSAtoMPA_SamplingEdgeErrorRate_SSA_SLVScurrent_4_Hybrid.png)
...
![SSAtoSSA_SamplingEdgeTestedBits_SSA_SLVScurrent_4_Hybrid](/outerTracker/OTtesting/PS/SSAtoSSA_SamplingEdgeTestedBits_SSA_SLVScurrent_4_Hybrid.png)

![SSAtoSSA_SamplingEdgeErrorRate_SSA_SLVScurrent_4_Hybrid](/outerTracker/OTtesting/PS/SSAtoSSA_SamplingEdgeErrorRate_SSA_SLVScurrent_4_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingTestedBits_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid](/outerTracker/OTtesting/PS/CICtoLpGBT_PatternMatchingTestedBits_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingErrorRate_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid](/outerTracker/OTtesting/PS/CICtoLpGBT_PatternMatchingErrorRate_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid.png)
...
![LpGBTforCICbypass_PhaseScanTestedBits_phyPort0_Hybrid](/outerTracker/OTtesting/PS/LpGBTforCICbypass_PhaseScanTestedBits_phyPort0_Hybrid.png)
...
![LpGBTforCICbypass_PhaseScanBitErrorRate_phyPort1_Hybrid](/outerTracker/OTtesting/PS/LpGBTforCICbypass_PhaseScanBitErrorRate_phyPort1_Hybrid.png)
...
![MPAtoCIC_PhaseScanTestedBits_MPA_SLVScurrent_1_Hybrid](/outerTracker/OTtesting/PS/MPAtoCIC_PhaseScanTestedBits_MPA_SLVScurrent_1_Hybrid.png)
...
![MPAtoCIC_PhaseScanErrorRate_MPA_SLVScurrent_1_Hybrid](/outerTracker/OTtesting/PS/MPAtoCIC_PhaseScanErrorRate_MPA_SLVScurrent_1_Hybrid.png)
...
![BERTerrorRatePhaseScan_OpticalGroup](/outerTracker/OTtesting/PS/BERTerrorRatePhaseScan_OpticalGroup.png)

![BERTtestedBitsCounterPhaseScan_OpticalGroup](/outerTracker/OTtesting/PS/BERTtesteBitCounterPhaseScan_OpticalGroup.png)
...
![BERTbestPhase_OpticalGroup](/outerTracker/OTtesting/PS/BERTbestPhase_OpticalGroup.png)
...
![BERTtestedBitsCounter_OpticalGroup](/outerTracker/OTtesting/PS/BERTtesteBitCounter_OpticalGroup.png)
...
![BERTerrorRate_OpticalGroup](/outerTracker/OTtesting/PS/BERTerrorRate_OpticalGroup.png)
...
![FECerrorCounter_OpticalGroup](/outerTracker/OTtesting/PS/FECerrorCounter_OpticalGroup.png)
...
![RegisterMatchingEfficiency_Hybrid](/outerTracker/OTtesting/PS/RegisterMatchingEfficiency_Hybrid.png)
...
![D_B(0)_LpGBT_DQM_VDD_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_VDD_OpticalGroup(0).png)
...
![D_B(0)_LpGBT_DQM_VDDA_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_VDDA_OpticalGroup(0).png)
...
![D_B(0)_LpGBT_DQM_LpGBTtemp_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_LpGBTtemp_OpticalGroup(0).png)
...
![D_B(0)_LpGBT_DQM_ADC0_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_ADC0_OpticalGroup(0).png) 

![D_B(0)_LpGBT_DQM_ADC3_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_ADC3_OpticalGroup(0).png) 
...
![D_B(0)_LpGBT_DQM_1V25_Left_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_1V25_Left_OpticalGroup(0).png) 
...
![D_B(0)_LpGBT_DQM_VIN_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_VIN_OpticalGroup(0).png) 
...
![D_B(0)_LpGBT_DQM_SensorTemp_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_SensorTemp_OpticalGroup(0).png) 
...
![D_B(0)_LpGBT_DQM_VTRxLeakageCurr_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_VTRxLeakageCurr_OpticalGroup(0).png)
...
![D_B(0)_LpGBT_DQM_BPOL12Vtemp_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_VTRxLeakageCurr_OpticalGroup(0).png)

![D_B(0)_LpGBT_DQM_BPOL2V5temp_OpticalGroup(0)](/outerTracker/OTtesting/common/D_B(0)_LpGBT_DQM_VTRxLeakageCurr_OpticalGroup(0).png)
...
![D_B(0)SSA_DQM_AVDD](/outerTracker/OTtesting/PS/SSA_DQM_AVDD.png)

![D_B(0)SSA_DQM_DVDD](/outerTracker/OTtesting/PS/SSA_DQM_DVDD.png)

MPA:

![D_B(0)MPA_DQM_AVDD](/outerTracker/OTtesting/PS/MPA_DQM_AVDD.png)

![D_B(0)MPA_DQM_DVDD](/outerTracker/OTtesting/PS/MPA_DQM_DVDD.png)
...
![SSA_DQM_temp](/outerTracker/OTtesting/PS/SSA_DQM_temp.png)

MPA:

![MPA_DQM_temp](/outerTracker/OTtesting/PS/MPA_DQM_temp.png)
