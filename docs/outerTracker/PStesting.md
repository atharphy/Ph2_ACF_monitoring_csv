...
![VREF_DACtoV_Chip](./OTtesting/PS/VREF_DACtoV_Chip.png)

The second one is the ADC calibration curve obtained during the procedure.

![ADC_Slope_MPA](./OTtesting/PS/ADC_Slope_MPA.png)
...
![CICtoLpGBT_PhaseAlignmentEfficiency](./OTtesting/PS/CICtoLpGBT_PhaseAlignmentEfficiency.png)
...
![CICtoLpGBT_FoundPhaseDistribution](./OTtesting/PS/CICtoLpGBT_FoundPhaseDistribution.png)
...
![CICtoLpGBT_BestPhase](./OTtesting/PS/CICtoLpGBT_BestPhase.png)
...
![Board_WordAlignmentBitSlipValues_Hybrid](./OTtesting/PS/Board_WordAlignmentBitSlipValues_Hybrid.png)
...
![Board_WordAlignmentRetryNumbers_Hybrid](./OTtesting/PS/Board_WordAlignmentRetryNumbers_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingTestedBits_Hybrid](./OTtesting/PS/CICtoLpGBT_PatternMatchingTestedBits_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingErrorRate_Hybrid](./OTtesting/PS/CICtoLpGBT_PatternMatchingErrorRate_Hybrid.png)
...
![MPAtoCIC_LockingEfficiency_Hybrid](./OTtesting/PS/MPAtoCIC_LockingEfficiency_Hybrid.png)
...
![MPAtoCIC_InputPhaseDistribution_Hybrid](./OTtesting/PS/MPAtoCIC_InputPhaseDistribution_Hybrid.png)
...
![MPAtoCIC_BestInputPhases_Hybrid](./OTtesting/PS/MPAtoCIC_BestInputPhases_Hybrid.png)
...
![MPAtoCIC_WordAlignmentDelay_Hybrid](./OTtesting/PS/MPAtoCIC_WordAlignmentDelay_Hybrid.png)
...
![CICBX0AlignmentDelay_Hybrid](./OTtesting/PS/CICBX0AlignmentDelay_Hybrid.png)
...
![MPAtoCIC_PatternMatchingTestedBits_Hybrid](./OTtesting/PS/MPAtoCIC_PatternMatchingTestedBits_Hybrid.png)

Small error rates (around 0.01–0.1%) are normal and not a concern. Large errors, e.g., 20%, would indicate a real problem.


![MPAtoCIC_PatternMatchingErrorRate_Hybrid](./OTtesting/PS/MPAtoCIC_PatternMatchingErrorRate_Hybrid.png)
...
![SSAtoMPA_PatternMatchingTestedBits_Hybrid](./OTtesting/PS/SSAtoMPA_PatternMatchingTestedBits_Hybrid.png)
...
![SSAtoMPA_PatternMatchingErrorRate_Hybrid](./OTtesting/PS/SSAtoMPA_PatternMatchingErrorRate_Hybrid.png)
...
###### ⚠️ Known issues
  ...
  Another issue has been found in the 10G firmware used during burnin testing in the majority of PS burnin centers leading to errors in the right hybrid as shown below.
  ![SSAtoMPA_PatternMatchingErrorRate_Hybrid_firmware](./OTtesting/PS/SSAtoMPA_PatternMatchingErrorRate_Hybrid_firmware.png)
...
![MPA_RingOscillatorDelayCounts_Hybrid](./OTtesting/PS/MPA_RingOscillatorDelayCounts_Hybrid.png)

![MPA_RingOscillatorInverterCounts_Hybrid](./OTtesting/PS/MPA_RingOscillatorInverterCounts_Hybrid.png)

And here for SSA

![SSA_RingOscillatorDelayCounts_Hybrid](./OTtesting/PS/SSA_RingOscillatorDelayCounts_Hybrid.png)

![SSA_RingOscillatorInverterCounts_Hybrid](./OTtesting/PS/SSA_RingOscillatorInverterCounts_Hybrid.png)
...
![ChannelOffsetValues_SSA_quick](./OTtesting/PS/ChannelOffsetValues_SSA_quick.png)

![2DChannelOffsetValues_MPA_quick](./OTtesting/PS/2DChannelOffsetValues_MPA_quick.png)
...
![ChannelOccupancyAfterOffsetEqualization_SSA_quick](./OTtesting/PS/ChannelOccupancyAfterOffsetEqualization_SSA_quick.png)

![2DChannelOccupancyAfterOffsetEqualization_MPA_quick](./OTtesting/PS/2DChannelOccupancyAfterOffsetEqualization_MPA_quick.png)
...
![ChannelPedestal_SSA_full](./OTtesting/PS/ChannelPedestal_SSA_full.png)

![PedestalDistribution_SSA_full](./OTtesting/PS/PedestalDistribution_SSA_full.png)



MPA plots:

![ChannelPedestal_MPA_full](./OTtesting/PS/ChannelPedestal_MPA_full.png)

![PedestalDistribution_MPA_full](./OTtesting/PS/PedestalDistribution_MPA_full.png)

Offset (local threshold) that equalizes the channel to the target. Valid offset values range from 0 to 31. Channels stuck at 0 or 31 indicate the allowed range was not sufficient to correct the channel.

SSA: 

![ChannelTrimBit_SSA_full](./OTtesting/PS/ChannelTrimBit_SSA_full.png)

MPA:

![ChannelTrimBit_MPA_full](./OTtesting/PS/ChannelTrimBit_MPA_full.png)
...
![SCurve_1channel_SSA](./OTtesting/PS/SCurve_1channel_SSA.png)

MPA:

![SCurve_1channel_MPA](./OTtesting/PS/SCurve_1channel_MPA.png)
...
![PulseHeightDistribution_SSA](./OTtesting/PS/PulseHeightDistribution_SSA.png)

MPA:

![PulseHeightDistribution_MPA](./OTtesting/PS/PulseHeightDistribution_MPA.png)
...
![ChannelPulseHeight_SSA](./OTtesting/PS/ChannelPulseHeight_SSA.png)

MPA:

![ChannelPulseHeight_MPA](./OTtesting/PS/ChannelPulseHeight_MPA.png)
...
![NoiseDistribution_SSA](./OTtesting/PS/NoiseDistribution_SSA.png)

![ChannelNoise_SSA](./OTtesting/PS/ChannelNoise_SSA.png)

MPA:
![NoiseDistribution_MPA](./OTtesting/PS/NoiseDistribution_MPA.png)

![ChannelNoise_MPA](./OTtesting/PS/ChannelNoise_MPA.png)
...
![2DChannelNoise_MPA](./OTtesting/PS/2DChannelNoise_MPA.png)

There are there very similar distributions summarizing the performance at the hybrid level.

Strips:

![StripNoiseDistribution_Hybrid](./OTtesting/PS/StripNoiseDistribution_Hybrid.png)

Higher noise toward the POH (SSA0 on right hybrid and SSA7 on left hybrid) is expected.

![StripChannelNoise_Hybrid](./OTtesting/PS/StripChannelNoise_Hybrid.png)



Pixels:

![PixelNoiseDistribution_Hybrid](./OTtesting/PS/PixelNoiseDistribution_Hybrid.png)

![PIxelChannelNoise_Hybrid](./OTtesting/PS/PixelChannelNoise_Hybrid.png)
...
![ThresholdVsDelayScan_SSA](./OTtesting/PS/ThresholdVsDelayScan_SSA.png)

MPA:

![ThresholdVsDelayScan_MPA](./OTtesting/PS/ThresholdVsDelayScan_MPA.png)
...
![BestThresholdAndDelay_SSA](./OTtesting/PS/BestThresholdAndDelay_SSA.png)

![BestThresholdAndDelay_MPA](./OTtesting/PS/BestThresholdAndDelay_MPA.png)
...
![ChannelOccupancy_Injection_0.000_MIP_SSA](./OTtesting/PS/ChannelOccupancy_Injection_0.000_MIP_SSA.png)

MPA:

![ChannelOccupancy_Injection_0.000_MIP_MPA](./OTtesting/PS/ChannelOccupancy_Injection_0.000_MIP_MPA.png)
...
![ChannelOccupancy_Injection_0.250_MIP_SSA](./OTtesting/PS/ChannelOccupancy_Injection_0.250_MIP_SSA.png)

![ChannelOccupancy_Injection_1.000_MIP_SSA](./OTtesting/PS/ChannelOccupancy_Injection_1.000_MIP_SSA.png)

MPA:

The inefficiency in the edge pixels are not real. They are a result of the large double pixels.

![ChannelOccupancy_Injection_0.250_MIP_MPA](./OTtesting/PS/ChannelOccupancy_Injection_0.250_MIP_MPA.png)

![ChannelOccupancy_Injection_1.000_MIP_SSA](./OTtesting/PS/ChannelOccupancy_Injection_1.000_MIP_MPA.png)
...
![CommonNoiseHits_OccupancyDriven_SSA](./OTtesting/PS/CommonNoiseHits_OccupancyDriven_Chip_SSA.png)

MPA:

![CommonNoiseHits_OccupancyDriven_MPA](./OTtesting/PS/CommonNoiseHits_OccupancyDriven_Chip_MPA.png)
...
![CommonNoiseHitsStrip_OccupancyDriven_Hybrid](./OTtesting/PS/CommonNoiseHitsStrip_OccupancyDriven_Hybrid.png)

![CommonNoiseHitsPixel_OccupancyDriven_Hybrid](./OTtesting/PS/CommonNoiseHitsPixel_OccupancyDriven_Hybrid.png)
...
![SSAtoMPA_CommonNoiseCorrelation_OccupancyDriven_Hybrid](./OTtesting/PS/SSAtoMPA_CommonNoiseCorrelation_OccupancyDriven_Hybrid.png)
...
![CommonNoiseStripPixelCorrelation_OccupancyDriven_Hybrid](./OTtesting/PS/CommonNoiseStripPixelCorrelation_OccupancyDriven_Hybrid.png)


- OpticalGroup/Module level distributions

![CommonNoiseHitsStrip_OccupancyDriven_OG](./OTtesting/PS/CommonNoiseHitsStrip_OccupancyDriven_OG.png)

![CommonNoiseHitsPixel_OccupancyDriven_OG](./OTtesting/PS/CommonNoiseHitsPixel_OccupancyDriven_OG.png)


And the correlation at the hybrid level:

![CommonNoiseStripPixelCorrelation_OccupancyDriven_OG](./OTtesting/PS/CommonNoiseStripPixelCorrelation_OccupancyDriven_OG.png)
...
![SSAtoMPA_SamplingEdgeTestedBits_SSA_SLVScurrent_4_Hybrid](./OTtesting/PS/SSAtoMPA_SamplingEdgeTestedBits_SSA_SLVScurrent_4_Hybrid.png)
...
![SSAtoMPA_SamplingEdgeErrorRate_SSA_SLVScurrent_4_Hybrid](./OTtesting/PS/SSAtoMPA_SamplingEdgeErrorRate_SSA_SLVScurrent_4_Hybrid.png)
...
![SSAtoSSA_SamplingEdgeTestedBits_SSA_SLVScurrent_4_Hybrid](./OTtesting/PS/SSAtoSSA_SamplingEdgeTestedBits_SSA_SLVScurrent_4_Hybrid.png)

![SSAtoSSA_SamplingEdgeErrorRate_SSA_SLVScurrent_4_Hybrid](./OTtesting/PS/SSAtoSSA_SamplingEdgeErrorRate_SSA_SLVScurrent_4_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingTestedBits_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid](./OTtesting/PS/CICtoLpGBT_PatternMatchingTestedBits_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingErrorRate_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid](./OTtesting/PS/CICtoLpGBT_PatternMatchingErrorRate_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid.png)
...
![LpGBTforCICbypass_PhaseScanTestedBits_phyPort0_Hybrid](./OTtesting/PS/LpGBTforCICbypass_PhaseScanTestedBits_phyPort0_Hybrid.png)
...
![LpGBTforCICbypass_PhaseScanBitErrorRate_phyPort1_Hybrid](./OTtesting/PS/LpGBTforCICbypass_PhaseScanBitErrorRate_phyPort1_Hybrid.png)
...
![MPAtoCIC_PhaseScanTestedBits_MPA_SLVScurrent_1_Hybrid](./OTtesting/PS/MPAtoCIC_PhaseScanTestedBits_MPA_SLVScurrent_1_Hybrid.png)
...
![MPAtoCIC_PhaseScanErrorRate_MPA_SLVScurrent_1_Hybrid](./OTtesting/PS/MPAtoCIC_PhaseScanErrorRate_MPA_SLVScurrent_1_Hybrid.png)
...
![BERTerrorRatePhaseScan_OpticalGroup](./OTtesting/PS/BERTerrorRatePhaseScan_OpticalGroup.png)

![BERTtestedBitsCounterPhaseScan_OpticalGroup](./OTtesting/PS/BERTtesteBitCounterPhaseScan_OpticalGroup.png)
...
![BERTbestPhase_OpticalGroup](./OTtesting/PS/BERTbestPhase_OpticalGroup.png)
...
![BERTtestedBitsCounter_OpticalGroup](./OTtesting/PS/BERTtesteBitCounter_OpticalGroup.png)
...
![BERTerrorRate_OpticalGroup](./OTtesting/PS/BERTerrorRate_OpticalGroup.png)
...
![FECerrorCounter_OpticalGroup](./OTtesting/PS/FECerrorCounter_OpticalGroup.png)
...
![RegisterMatchingEfficiency_Hybrid](./OTtesting/PS/RegisterMatchingEfficiency_Hybrid.png)
...
![D_B(0)SSA_DQM_AVDD](./OTtesting/PS/SSA_DQM_AVDD.png)

![D_B(0)SSA_DQM_DVDD](./OTtesting/PS/SSA_DQM_DVDD.png)

MPA:

![D_B(0)MPA_DQM_AVDD](./OTtesting/PS/MPA_DQM_AVDD.png)

![D_B(0)MPA_DQM_DVDD](./OTtesting/PS/MPA_DQM_DVDD.png)
...
![SSA_DQM_temp](./OTtesting/PS/SSA_DQM_temp.png)

MPA:

![MPA_DQM_temp](./OTtesting/PS/MPA_DQM_temp.png)
