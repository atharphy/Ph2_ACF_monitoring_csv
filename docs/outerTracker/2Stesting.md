...
![CICtoLpGBT_PhaseAlignmentEfficiency](/outerTracker/OTtesting/2S/CICtoLpGBT_PhaseAlignmentEfficiency.png)
...
![CICtoLpGBT_FoundPhaseDistribution](/outerTracker/OTtesting/2S/CICtoLpGBT_FoundPhaseDistribution.png)
...
![CICtoLpGBT_BestPhase](/outerTracker/OTtesting/2S/CICtoLpGBT_BestPhase.png)
...
![Board_WordAlignmentBitSlipValues_Hybrid](/outerTracker/OTtesting/2S/Board_WordAlignmentBitSlipValues_Hybrid.png)
...
![Board_WordAlignmentRetryNumbers_Hybrid](/outerTracker/OTtesting/2S/Board_WordAlignmentRetryNumbers_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingTestedBits_Hybrid](/outerTracker/OTtesting/2S/CICtoLpGBT_PatternMatchingTestedBits_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingErrorRate_Hybrid](/outerTracker/OTtesting/2S/CICtoLpGBT_PatternMatchingErrorRate_Hybrid.png)
...
![CBCtoCIC_LockingEfficiency_Hybrid](/outerTracker/OTtesting/2S/CBCtoCIC_LockingEfficiency_Hybrid.png)
...
![CBCtoCIC_InputPhaseDistribution_Hybrid](/outerTracker/OTtesting/2S/CBCtoCIC_InputPhaseDistribution_Hybrid.png)
...
![CBCtoCIC_BestInputPhases_Hybrid](/outerTracker/OTtesting/2S/CBCtoCIC_BestInputPhases_Hybrid.png)
...
![CBCtoCIC_WordAlignmentDelay_Hybrid](/outerTracker/OTtesting/2S/CBCtoCIC_WordAlignmentDelay_Hybrid.png)
...
![CICBX0AlignmentDelay_Hybrid](/outerTracker/OTtesting/2S/CICBX0AlignmentDelay_Hybrid.png)
...
![CBCtoCIC_PatternMatchingTestedBits_Hybrid](/outerTracker/OTtesting/2S/CBCtoCIC_PatternMatchingTestedBits_Hybrid.png)

Small error rates (around 0.01–0.1%) are normal and not a concern. Large errors, e.g., 20%, would indicate a real problem.


![CBCtoCIC_PatternMatchingErrorRate_Hybrid](/outerTracker/OTtesting/2S/CBCtoCIC_PatternMatchingErrorRate_Hybrid.png)
...
![ChannelOffsetValues_Chip](/outerTracker/OTtesting/2S/ChannelOffsetValues_Chip.png)
...
![ChannelOccupancyAfterOffsetEqualization_Chip](/outerTracker/OTtesting/2S/ChannelOccupancyAfterOffsetEqualization_Chip.png)
...
![SCurve_1channel](/outerTracker/OTtesting/2S/SCurve_1channel.png)
...
![SCurve_Chip](/outerTracker/OTtesting/2S/SCurve_Chip.png)
...
![PedestalDistribution_Chip](/outerTracker/OTtesting/2S/PedestalDistribution_Chip.png)
...
![ChannelPedestal_Chip](/outerTracker/OTtesting/2S/ChannelPedestal_Chip.png)

Similar distribution are also shown for the noise.

![NoiseDistribution_Chip](/outerTracker/OTtesting/2S/NoiseDistribution_Chip.png)

![ChannelNoise_Chip](/outerTracker/OTtesting/2S/ChannelNoise_Chip.png)

The bottom sensor has a higher noise compared to the top because of longer traces in the foldover hybrid.

![ChannelNoiseTop_Chip](/outerTracker/OTtesting/2S/ChannelNoiseTop_Chip.png)

![ChannelNoiseBottom_Chip](/outerTracker/OTtesting/2S/ChannelNoiseBottom_Chip.png)

There are there very similar distributions summarizing the performance at the hybrid level.

![NoiseDistribution](/outerTracker/OTtesting/2S/NoiseDistribution.png)

![StripChannelNoise](/outerTracker/OTtesting/2S/StripChannelNoise.png)
...
![StripChannelNoiseTop](/outerTracker/OTtesting/2S/StripChannelNoiseTop.png)

![StripChannelNoiseBottom](/outerTracker/OTtesting/2S/StripChannelNoiseBottom.png)
...
![StripChannelNoise_brokenBons](/outerTracker/OTtesting/2S/StripChannelNoise_brokenBonds.png)
...
![ThresholdVsDelayScan_Chip](/outerTracker/OTtesting/2S/ThresholdVsDelayScan_Chip.png)
...
![BestThresholdAndDelay_Chip](/outerTracker/OTtesting/2S/BestThresholdAndDelay_Chip.png)
...
![ChannelOccupancy_Injection_0.000_MIP_Chip](/outerTracker/OTtesting/2S/ChannelOccupancy_Injection_0.000_MIP_Chip_Chip.png)
...
![ChannelOccupancy_Injection_0.250_MIP_Chip](/outerTracker/OTtesting/2S/ChannelOccupancy_Injection_0.250_MIP_Chip.png)

![ChannelOccupancy_Injection_1.000_MIP_Chip](/outerTracker/OTtesting/2S/ChannelOccupancy_Injection_1.000_MIP_Chip.png)
...
![CommonNoiseHits_OccupancyDriven_Chip](/outerTracker/OTtesting/2S/CommonNoiseHits_OccupancyDriven_Chip.png)
...
![CommonNoiseTopBottomCorrelation_OccupancyDriven_Chip](/outerTracker/OTtesting/2S/CommonNoiseTopBottomCorrelation_OccupancyDriven_Chip.png)

Here we show the correlaton of the chip with the rest of the hybrid.

![CommonNoiseHybridCorrelation_OccupancyDriven_Chip](/outerTracker/OTtesting/2S/CommonNoiseHybridCorrelation_OccupancyDriven_Chip.png)
...
![2DChipHits_OccupancyDriven_Chip](/outerTracker/OTtesting/2S/2DChipHits_OccupancyDriven_Chip.png)
...
![CommonNoiseHits_OccupancyDriven_Hybrid](/outerTracker/OTtesting/2S/CommonNoiseHits_OccupancyDriven_Hybrid.png)
...
![CommonNoiseTopBottomCorrelation_OccupancyDriven_Hybrid](/outerTracker/OTtesting/2S/CommonNoiseTopBottomCorrelation_OccupancyDriven_Hybrid.png)
...
![CommonNoiseHits_OccupancyDriven_OpticalGroup](/outerTracker/OTtesting/2S/CommonNoiseHits_OccupancyDriven_OpticalGroup.png)

The two hybrids below appear uncorrelated.

![CommonNoiseCrossHybridCorrelation_OccupancyDriven_OpticalGroup](/outerTracker/OTtesting/2S/CommonNoiseCrossHybridCorrelation_OccupancyDriven_OpticalGroup.png)
...
![CICtoLpGBT_PatternMatchingTestedBits_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid](/outerTracker/OTtesting/2S/CICtoLpGBT_PatternMatchingTestedBits_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid.png)
...
![CICtoLpGBT_PatternMatchingErrorRate_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid](/outerTracker/OTtesting/2S/CICtoLpGBT_PatternMatchingErrorRate_CIC_SLVScurrent_5_LpGBT_Clock_Polarity_0_Clock_Strength_7_Hybrid.png)
...
![LpGBTforCICbypass_PhaseScanTestedBits_phyPort0_Hybrid](/outerTracker/OTtesting/2S/LpGBTforCICbypass_PhaseScanTestedBits_phyPort0_Hybrid.png)
...
![LpGBTforCICbypass_PhaseScanBitErrorRate_phyPort0_Hybrid](/outerTracker/OTtesting/2S/LpGBTforCICbypass_PhaseScanBitErrorRate_phyPort0_Hybrid.png)
...
![CBCtoCIC_PhaseScanTestedBits_CBC_SLVScurrent_0_Hybrid](/outerTracker/OTtesting/2S/CBCtoCIC_PhaseScanTestedBits_CBC_SLVScurrent_0_Hybrid.png)
...
![CBCtoCIC_PhaseScanErrorRate_CBC_SLVScurrent_0_Hybrid](/outerTracker/OTtesting/2S/CBCtoCIC_PhaseScanErrorRate_CBC_SLVScurrent_0_Hybrid.png)
...
![BERTerrorRatePhaseScan_OpticalGroup](/outerTracker/OTtesting/2S/BERTerrorRatePhaseScan_OpticalGroup.png)

![BERTtestedBitsCounterPhaseScan_OpticalGroup](/outerTracker/OTtesting/2S/BERTtestedBitsCounterPhaseScan_OpticalGroup.png)
...
![BERTbestPhase_OpticalGroup](/outerTracker/OTtesting/2S/BERTbestPhase_OpticalGroup.png)
...
![BERTtestedBitsCounter_OpticalGroup](/outerTracker/OTtesting/2S/BERTtestedBitsCounter_OpticalGroup.png)
...
![BERTerrorRate_OpticalGroup](/outerTracker/OTtesting/2S/BERTerrorRate_OpticalGroup.png)
...
![FECerrorCounter_OpticalGroup](/outerTracker/OTtesting/2S/FECerrorCounter_OpticalGroup.png)
...
![RegisterMatchingEfficiency_Hybrid](/outerTracker/OTtesting/2S/RegisterMatchingEfficiency_Hybrid.png)
