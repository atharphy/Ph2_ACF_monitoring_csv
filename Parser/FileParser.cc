...
{
    std::vector<std::string> listOfStringSettings{"RegNameDAC1", "RegNameDAC2", "DataOutputDir", "KIRA_ID", "OTinjectionOccupancyScan_ListOfInjectedPulses", "OTinjectionOccupancyScan_ListOfInjectedPulses"};
    pugi::xml_document       doc;
    openHWconfig(pFilename, doc);
