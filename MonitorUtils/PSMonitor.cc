...
{
    std::cout<< __PRETTY_FUNCTION__ << " [" << __LINE__ << "] " <<  Ph2_HwDescription::ReadoutChip::getFrontEndName(theChip->getFrontEndType())  << "monitorValueName = " << monitorValueName << std::endl;
